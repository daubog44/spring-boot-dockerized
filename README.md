...
Avvia PostgreSQL su Docker, compila tutti i moduli una volta sola, lancia Eureka, ne attende la porta e poi avvia i quattro servizi, ognuno nella propria finestra. Al termine stampa la mappa degli URL. I log finiscono anche in `.dev-logs/`.
...
Termina solo i processi Java dello stack: le altre applicazioni in ascolto sulle stesse porte non vengono toccate. PostgreSQL resta attivo, fermalo con `task docker-down`.
