...
cmd "task new-client FROM=<mod1> TO=<mod2>" "client OpenFeign per chiamare un microservizio"
...
note "new-client: DTO=<NomeDto> per agganciare il tipo condiviso (task --summary new-client)"
