...
Write-Cmd 'task new-client FROM=<mod1> TO=<mod2>' 'client OpenFeign (con auto-rilevamento rotta/DTO)'
...
Write-Note 'new-client: ROUTE=/api/... NAME=... DTO=... (task --summary new-client)'
