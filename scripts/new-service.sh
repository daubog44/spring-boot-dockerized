...
EOF
  ...
  mkdir -p "$MODULE_DIR/src/main/java/$PACKAGE_PATH/controller"
  cat >"$MODULE_DIR/src/main/java/$PACKAGE_PATH/controller/GlobalExceptionHandler.java" <<EOF
...
EOF
  echo "  demo/$MODULE/src/main/java/$PACKAGE_PATH/controller/GlobalExceptionHandler.java"
fi
